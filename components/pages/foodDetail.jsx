  ...
  return (
    ...
    />
            ...
            <div className="w-full flex  lg:flex-row  lg:justify-center  lg:items-center items-center px-4 mb-4 space-y-0 space-x-1">
              ...
              <button className=" btn-md btn-active btn-secondary py-2 text-white  w-full sm:max-w-[320px] rounded-[24px] hover:bg-pink-400 sm:mr-4"  onClick={() => {
                router.push('/home/basket')
              }}>
                Buy Now
              </button>
            ...
            <div className="w-full">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 md:gap-4">
